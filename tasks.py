...
async def gp_start():
    ...
    sw_search_str = '上穿5日均线；上穿10日均线；股价大于20日均线；最大涨幅<4%；市盈ttm大于0；股价在3到35元之间；非中字头；非科创板；非*st；非北交所；非银行股；资金流入的；换手率大于上一交易日换手率的0.8倍以上；'
    xw_search_str = '上穿5日均线；上穿10日均线；股价大于20日均线；最大涨幅<4%；；市盈ttm大于0；股价在3到35元之间；非中字头；非科创板；非*st；非北交所；非银行股；资金流入的；换手率大于上一交易日换手率的1.2倍以上；'
