...
async def gp_start():
    ...
    sw_search_str = '上穿5日均线；上穿10日均线；股价大于20日均线；最大涨幅<4%；kdj金叉；市盈ttm大于0；股价在3到35元之间；非中字头；非科创板；非*st；非北交所；非银行股；资金流入的；换手率大于上一交易日换手率的0.8倍以上；'
    xw_search_str = '上穿5日均线；上穿10日均线；股价大于20日均线；最大涨幅<4%；kdj金叉；市盈ttm大于0；股价在3到35元之间；非中字头；非科创板；非*st；非北交所；非银行股；资金流入的；换手率大于上一交易日换手率的1.2倍以上；'
...
async def add_task():
    ...
    scheduler.add_job(gp_start, 'cron', id='push_start', hour='09', minute='00', timezone='Asia/Shanghai',
                      replace_existing=True)
